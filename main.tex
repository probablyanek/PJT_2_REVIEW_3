...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.55\textwidth}
			\centering
			% TikZ Hardware Connection Diagram — scaled to fit within column
			\begin{tikzpicture}[scale=0.65, transform shape]
				\node[sysblock, fill=blue!12] (radar) {HLK-LD2450\\24\,GHz Radar};
				\node[sysblock, fill=green!12, right=1.2cm of radar] (esp) {ESP32-S3\\Sensor Node};
				\node[sysblock, fill=orange!12, right=1.2cm of esp] (tag) {ESP32\\Active Tag};
...
\begin{frame}
	...
	\begin{tikzpicture}[scale=0.75, transform shape]
		...
		\node[annot, below=0.12cm of data, text width=1.8cm, align=center] {70 static poses\\30s each\\Micro-motion\\Polar ground truth};
...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.45\textwidth}
			\begin{figure}
				\includegraphics[width=\linewidth, height=0.50\textheight, keepaspectratio]{Placeholder.png}
...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.55\textwidth}
			\begin{figure}
				\includegraphics[width=0.46\linewidth, height=0.42\textheight, keepaspectratio]{Placeholder.png}
				\hfill
				\includegraphics[width=0.46\linewidth, height=0.42\textheight, keepaspectratio]{Placeholder.png}
